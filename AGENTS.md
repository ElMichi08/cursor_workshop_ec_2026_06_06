...
Project skills live in `.agents/skills/`. `skills-lock.json` records installed versions; restore them with `npx skills experimental_install`.

Use relevant project skills for framework-specific work.
